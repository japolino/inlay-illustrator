...
function renderParserSection({ ui, config, parserConnections, actions, rerender }) {
  ...
  ui.addNumber(section, "parserMaxTokens", "Maximum token budget", 0, 32768, "0 keeps the provider default output budget. Explicit max_tokens or max_completion_tokens in Parser parameters takes precedence.");
